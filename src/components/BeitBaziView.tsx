...
import { MessageSquare, Sparkles, Send, RefreshCw, Trophy, Crown, HelpCircle, ArrowRight, Heart, Share2, Volume2, VolumeX, AlertCircle } from "lucide-react";
          ...
          {errorMsg && (
            (() => {
              ...
              if (isPermissionDenied) {
                return (
                  <div className="bg-stone-900/90 border border-amber-500/20 rounded-3xl p-6 text-left max-w-xl mx-auto shadow-2xl relative overflow-hidden my-4">
